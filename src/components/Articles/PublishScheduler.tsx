...
import { Calendar as CalendarIcon, CheckCircle, Clock, ExternalLink, InfoIcon, Loader2, Send } from "lucide-react";
        ...
        {!hasConnectedPlatforms ? (
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Connect Blogger or Medium to publish your content
              </p>
            </div>
            <Button 
          ...
          <>
            <Alert variant="default" className="bg-blue-50 dark:bg-blue-900/20 text-blue-800 dark:text-blue-200 border-blue-200 dark:border-blue-800">
              ...
              <AlertDescription>
                Article will be published with the title: <strong>{title}</strong>
              </AlertDescription>
            </Alert>
              ...
              {integrations.blogger && (
                <div className="flex items-center justify-between p-3 rounded-md bg-muted/20 border">
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="blogger-switch" className="cursor-pointer font-medium">Blogger</Label>
                  </div>
                  <Switch
                    id="blogger-switch"
              ...
              {integrations.medium && (
                <div className="flex items-center justify-between p-3 rounded-md bg-muted/20 border">
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="medium-switch" className="cursor-pointer font-medium">Medium</Label>
                  </div>
                  <Switch
                    id="medium-switch"
